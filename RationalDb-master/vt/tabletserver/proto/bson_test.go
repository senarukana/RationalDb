...
func TestQuery(t *testing.T) {
	...
	if custom.Sql != unmarshalled.Sql {
		t.Error("want %v, got %v", custom.Sql, unmarshalled.Sql)
	}
	if custom.TransactionId != unmarshalled.TransactionId {
		t.Error("want %v, got %v", custom.TransactionId, unmarshalled.TransactionId)
	}
	if custom.SessionId != unmarshalled.SessionId {
		t.Error("want %v, got %v", custom.SessionId, unmarshalled.SessionId)
	}
	if custom.BindVariables["val"].(int64) != unmarshalled.BindVariables["val"].(int64) {
		t.Error("want %v, got %v", custom.BindVariables["val"], unmarshalled.BindVariables["val"])
	}
...
func TestSession(t *testing.T) {
	...
	if custom != unmarshalled {
		t.Error("want %v, got %#v", custom, unmarshalled)
	}
...
func TestQueryList(t *testing.T) {
	...
	if custom.Queries[0].Sql != unmarshalled.Queries[0].Sql {
		t.Error("want %v, got %v", custom.Queries[0].Sql, unmarshalled.Queries[0].Sql)
	}
	if custom.Queries[0].BindVariables["val"].(int64) != unmarshalled.Queries[0].BindVariables["val"].(int64) {
		t.Error("want %v, got %v", custom.Queries[0].BindVariables["val"], unmarshalled.Queries[0].BindVariables["val"])
	}
