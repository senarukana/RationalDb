...
func TestWrite(t *testing.T) {
	...
	if string(cw.Bytes()) != "1234" {
		t.Error("Expecting 1234, received %s", cw.Bytes())
	}
	cw.WriteString("56")
	if string(cw.Bytes()) != "123456" {
		t.Error("Expecting 123456, received %s", cw.Bytes())
	}
	if cw.Len() != 6 {
		t.Error("Expecting 6, received %d", cw.Len())
	}
}
...
func TestTruncate(t *testing.T) {
	...
	if string(cw.Bytes()) != "12345678" {
		t.Error("Expecting 12345678, received %s", cw.Bytes())
	}
	cw.Truncate(5)
	if string(cw.Bytes()) != "12345" {
		t.Error("Expecting 12345, received %s", cw.Bytes())
	}
	cw.Truncate(2)
	...
	cw.Reset()
	if cw.Len() != 0 {
		t.Error("Expecting 0, received %d", cw.Len())
	}
}
...
func TestWriteTo(t *testing.T) {
	...
	if string(cw2.Bytes()) != "123456789" {
		t.Error("Expecting 123456789, received %s", cw2.Bytes())
	}
}
